...
public class PlayerController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        {
            new Vector3(-step_Length, 0f, 0f),   // LEFT
            new Vector3(0f, step_Length, 0f),    // UP
            new Vector3(step_Length, 0f, 0f),    // RIGHT
            new Vector3(0f, -step_Length, 0f)    // DOWN
        };
    }
    ...
    void InitPlayer()
    {
        ...
        switch (direction)
        {
            case PlayerDirection.RIGHT:
                nodes[1].position = nodes[0].position - new Vector3(step_Length, 0f, 0f);
                nodes[2].position = nodes[0].position - new Vector3(step_Length * 2f, 0f, 0f);
                break;
            ...
            case PlayerDirection.UP:
                nodes[1].position = nodes[0].position - new Vector3(0f, step_Length, 0f);
                nodes[2].position = nodes[0].position - new Vector3(0f, step_Length * 2f, 0f);
                break;
    ...
    void Move()
    {
        ...
        // Create new tail node if fruit was eaten
    ...
    void OnTriggerEnter(Collider target)
    {
        ...
        if (target.tag == Tags.FRUIT)
        {
            ...
            AudioManager.instance.Play_PickUpS();
